...
//提供一个默认数据变量
Motor_send_data_t msd_CHASSIS_6020;
Motor_send_data_t msd_CHASSIS_3508_2006;

//提供一个默认数据变量
Motor_send_data_t msd_GIMBAL_6020;
Motor_send_data_t msd_GIMBAL_3508_2006;
...
public:
  ...
  uint8_t ISDir();
	...
	double UpTorquePid(Kpid_t kpid, double expectations, int address, double maxspeed, RM_KalmanFilter_t* KalmanFilter, double (RM_PID::*RM_PIDx)(Kpid_t, double, double, double) = &RM_PID::GetPidPos);
	//过零处理
...
inline double RM_Motor::UpTorquePid(Kpid_t kpid, double expectations, int address, double maxspeed, RM_KalmanFilter_t* KalmanFilter, double (RM_PID::*RM_PIDx)(Kpid_t, double, double, double))
{
...
//底盘电机数量数量
#define _CHASSIS_Motor2006_SIZE 1
#define _CHASSIS_Motor3508_SIZE 2
#define _CHASSIS_Motor6020_SIZE 2
Motor_t _CHASSIS_Motor2006_[_CHASSIS_Motor2006_SIZE] = { 0 };uint8_t _CHASSIS_Motor2006_ID_[_CHASSIS_Motor2006_SIZE] = { 100 };
Motor_t _CHASSIS_Motor3508_[_CHASSIS_Motor3508_SIZE] = { 0 };uint8_t _CHASSIS_Motor3508_ID_[_CHASSIS_Motor3508_SIZE] = { 1, 2 };
Motor_t _CHASSIS_Motor6020_[_CHASSIS_Motor6020_SIZE] = { 0 };uint8_t _CHASSIS_Motor6020_ID_[_CHASSIS_Motor6020_SIZE] = { 1, 2 };
RM_Motor CHASSIS_Motor2006(0x200,_CHASSIS_Motor2006_SIZE,_CHASSIS_Motor2006_,_CHASSIS_Motor2006_ID_);
RM_Motor CHASSIS_Motor3508(0x200,_CHASSIS_Motor3508_SIZE,_CHASSIS_Motor3508_,_CHASSIS_Motor3508_ID_);
RM_Motor CHASSIS_Motor6020(0x204,_CHASSIS_Motor6020_SIZE,_CHASSIS_Motor6020_,_CHASSIS_Motor6020_ID_);

//云台电机数量数量
#define _GIMBAL_Motor2006_SIZE 1
#define _GIMBAL_Motor3508_SIZE 2
#define _GIMBAL_Motor6020_SIZE 1
Motor_t _GIMBAL_Motor2006_[_GIMBAL_Motor2006_SIZE] = { 0 };uint8_t _GIMBAL_Motor2006_ID_[_GIMBAL_Motor2006_SIZE] = { 1 };
Motor_t _GIMBAL_Motor3508_[_GIMBAL_Motor3508_SIZE] = { 0 };uint8_t _GIMBAL_Motor3508_ID_[_GIMBAL_Motor3508_SIZE] = { 3,4 };
Motor_t _GIMBAL_Motor6020_[_GIMBAL_Motor6020_SIZE] = { 0 };uint8_t _GIMBAL_Motor6020_ID_[_GIMBAL_Motor6020_SIZE] = { 1 };
RM_Motor GIMBAL_Motor2006(0x200,_GIMBAL_Motor2006_SIZE,_GIMBAL_Motor2006_,_GIMBAL_Motor2006_ID_);
RM_Motor GIMBAL_Motor3508(0x200,_GIMBAL_Motor3508_SIZE,_GIMBAL_Motor3508_,_GIMBAL_Motor3508_ID_);
RM_Motor GIMBAL_Motor6020(0x204,_GIMBAL_Motor6020_SIZE,_GIMBAL_Motor6020_,_GIMBAL_Motor6020_ID_);
...
//设置位置环最小处理
double RM_Motor::MinPosHelm(float expectations, float feedback, float* speed,float maxspeed, float maxpos)
{
		//x1当前位置
		//x2当前位置的对半位置
		//x3反馈位置
...
//设置速度环最小处理
double RM_Motor::SpeedHelm(RM_PID *Rm_Pid, Kpid_t kpid, double speed, double feedback, double maxspeed, int isminmodeidx)
{
...
//过零处理
float RM_Motor::Zero_crossing_processing(float expectations, float feedback, float maxpos )
{
	double tempcin = expectations;
	if(maxpos != 0)
	{
