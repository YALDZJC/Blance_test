...
RM_PID theta_err;
Kpid_t K_theta_err(90, 0, 15);
//滤波相关
TD_quadratic V_speed(150);

TD_quadratic td_out_R(200);
TD_quadratic td_out_L(200);
...
float tar_L0, FF = 0, rc_dc = 0.0002, go_dc = 0,turn_dc = -0.0001;
//float Kp = -200,Kd = -40,P_out,D_out;
float tar_dc = 0.0001;

float Poly_Coefficient[12][4]={	{-290.566078790703,	313.966493583809,	-225.234135407239,	-3.60917035109799},
																{12.8184874829383,	-21.3578071740925,	-23.8822764700698,	-0.285501397683555},
																{-197.817918761292,	161.304142045317,	-43.8598799800396,	-18.2759766794716},
																{-197.817918761292,	161.304142045317,	-43.8598799800396,	-18.2759766794716},
																{-1743.55736601093,	1524.11588840913,	-467.929826994736,	58.0702325491503},
																{-33.7033739853474,	30.7710512777094,	-10.1659738548760,	1.84872379506632},
																{-364.118805536182,	337.087160452159,	-114.310937733650,	20.9615707443297},
																{-47.6446326961743,	42.8855589404026,	-13.5121870631355,	2.78277608944176},
																{-1089.22018733770,	950.000726454693,	-290.056823709606,	34.7316563714226},
																{-823.582369528186,	715.890191988324,	-217.691405448087,	26.3074387004558},
																{1383.32066699025,	-1132.41266170312,	310.138550614808,	112.912954493547},
																{40.6027052971267,	-34.3444359437004,	9.98225074729615,	1.80097304396123}};

float LQR_K[12]={ 
  -51.3607,  -10.9967,  -25.5208,  -24.5450,   35.8487 ,   4.2152,
   47.5217,   11.6438,   24.3876,   23.7809,  123.5393 ,  13.3298
};
