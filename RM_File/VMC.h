...
void VMC_leg_t::Up_Left(float pitch_Angle, float pitch_Gyro, float dt)
{
	...
	this->VMC_data.XD = this->VMC_data.l5 + this->VMC_data.l4 * arm_cos_f32(this->VMC_data.phi4);//D的x坐标
	this->VMC_data.XB = this->VMC_data.l1 * arm_cos_f32(this->VMC_data.phi1); //B的x坐标
